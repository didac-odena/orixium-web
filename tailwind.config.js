    ...
    theme: {
        extend: {
            ...
            colors: {
                ...
                "surface-2":
                    "rgb(from var(--color-surface-2) r g b / <alpha-value>)",
                "surface-3":
                    "rgb(from var(--color-surface-3) r g b / <alpha-value>)",
                ink: "rgb(from var(--color-ink) r g b / <alpha-value>)",
                "ink-soft":
                    "rgb(from var(--color-ink-soft) r g b / <alpha-value>)",
                muted: "rgb(from var(--color-muted) r g b / <alpha-value>)",
                border: "rgb(from var(--color-border) r g b / <alpha-value>)",
                "border-strong":
                    "rgb(from var(--color-border-strong) r g b / <alpha-value>)",
                accent: "rgb(from var(--color-accent) r g b / <alpha-value>)",
                "accent-2":
                    "rgb(from var(--color-accent-2) r g b / <alpha-value>)",
                ...
                "ring-offset":
                    "rgb(from var(--color-ring-offset) r g b / <alpha-value>)",
            },
            fontFamily: {
                sans: [
                    "var(--font-sans)",
